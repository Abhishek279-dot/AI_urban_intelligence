...
class Incident(Base):
    ...
    bus_id: Mapped[str] = mapped_column(String(20), ForeignKey("buses.bus_id", ondelete="CASCADE"), nullable=False)
    ...
    incidents_status: Mapped[str] = mapped_column(String(20), default="Detected")
    plate_number: Mapped[str | None] = mapped_column(String(20))
    detected_at: Mapped[object] = mapped_column(DateTime, server_default=func.current_timestamp())
